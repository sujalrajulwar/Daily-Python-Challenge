...
# Difficulty: BasicAccuracy: 74.85%Submissions: 37K+Points: 1
...
# Your task is to complete the function to_upper()
# which takes the string str as an argument and returns the resultant string.
